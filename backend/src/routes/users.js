...
router.post('/', async (req, res) => {
   try {
      ...
      const { email, firtsName, lastName, userName, picture, password } =
         req.body;
...
router.put('/precarga', async (req, res) => {
   const { email } = req.body;
   ...
   try {
      var superAdmin = await Users.findOrCreate({
         where: {
            ...
            userName: 'La-Mili',
            picture:
               'https://img.freepik.com/vector-gratis/diseno-ilustracion-vector-personaje-avatar-mujer-joven_24877-18536.jpg',
      ...
      var superAdmin2 = await Users.findOrCreate({
         where: {
            ...
            picture:
               'https://lh3.googleusercontent.com/a-/AOh14GiUh1_SvyqlWseAfbiBc7zzmGHcr3_La0rCRMF7jA=s96-c-rg-br100',
            role: 'ROLE_SUPER_ADMIN',
         },
      });
      var superAdmin3 = await Users.findOrCreate({
         where: {
            ...
            picture:
               'https://lh3.googleusercontent.com/a-/AOh14GiCaJtDxJVq8_citOjdiBHTqCuZ6bXmeKKZMma77w=s96-c-rg-br100',
            role: 'ROLE_SUPER_ADMIN',
         },
      });
      var superAdmin4 = await Users.findOrCreate({
         where: {
            email: 'alejobengo@gmail.com',
            password: 'Malditosaul1!',
            firtsName: 'Alejo',
            lastName: 'Bengoechea',
            userName: 'Alejobengo',
            picture:
