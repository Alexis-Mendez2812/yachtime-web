...
import { postYateForm, putYateForm } from "../../Redux/Actions/FormActions/formAction";
					...
					<div className="Form-body">
						<form className="Form-form">
							...
							<div className="Form-div-inputs">
								<div className="inputContUp">
									<div className="width100">
										<label className="Form-label ">{product.id||"id"}</label> <br />
							...
							<div className="Form-div-controlers">
								...
								{controller.pictures && (
									<p className="Form-controller">●{controller.pictures}</p>
								)}
										...
										product.pictures.map((pic, i) => {
											return (
												...
												>
													...
													<img src={pic} alt="" style={{ width: "10vw" }} />
												</ImageListItem>
											);
										})}
								</Box>
